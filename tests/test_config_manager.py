...
import json
import pytest
from gateway import load_config, expand_env_vars
...
def test_config_manager_loads_budgets_from_env(monkeypatch, tmp_path):
    env_budgets = [
        {"api_key": "sk-env-key-1", "daily_limit_usd": 15.0, "monthly_limit_usd": 150.0},
        {"api_key": "sk-env-key-2", "daily_limit_usd": 25.0, "monthly_limit_usd": 250.0}
    ]
